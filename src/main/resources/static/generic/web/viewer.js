...
(function mozPrintCallbackPolyfillClosure() {
  ...
  function next() {
    if (!canvases) {
      return; // Print task cancelled by pay (state reset in abort())
    }
...
var PDFHistory = {
  ...
  initialize: function pdfHistoryInitialize(fingerprint, linkService) {
    ...
    window.addEventListener('popstate', function pdfHistoryPopstate(evt) {
      ...
      if (evt.state) {
        ...
        // Handle the pay modifying the hash of a loaded document.
  ...
  get isHashChangeUnlocked() {
    ...
    // If it is not reset, the pay would not be able to change the hash.
  ...
  push: function pdfHistoryPush(params, isInitialBookmark) {
    ...
    if (isInitialBookmark) {
      ...
      if (!target) {
        // Invoked when the pay specifies an initial bookmark,
  ...
  _getPreviousParams: function pdfHistory_getPreviousParams(onlyCheckPage,
    ...
    if (this.uid > 0 && !(this.previousBookmark && this.previousPage)) {
      ...
      // effectively preventing the pay from going back/forward in the history.
      //
      ...
      //    (This is either due to a bad PDF generator, or the pay making a
...
var PDFPresentationMode = (function PDFPresentationModeClosure() {
  ...
  PDFPresentationMode.prototype = {
    ...
    /**
     * Switches page when the pay scrolls (using a scroll wheel or a touchpad)
    ...
    _enter: function PDFPresentationMode_enter() {
      ...
      // for the pay to deselect text that is selected (e.g. with "Select all")
...
var GrabToPan = (function GrabToPanClosure() {
  ...
  GrabToPan.prototype = {
    ...
    _onmousedown: function GrabToPan__onmousedown(event) {
      ...
      // When a scroll event occurs before a mousemove, assume that the pay
...
var PDFDocumentProperties = (function PDFDocumentPropertiesClosure() {
  ...
  PDFDocumentProperties.prototype = {
    ...
    _parseDate: function PDFDocumentProperties_parseDate(inputDate) {
      ...
      // and doesn't use the pay's time zone (they're effectively ignoring
      ...
      // Return the new date format from the pay's locale.
...
var PDFViewerApplication = {
  ...
  open: function pdfViewOpen(file, scale, password,
    ...
    PDFJS.getDocument(parameters, pdfDataRangeTransport, passwordNeeded,
      ...
      function getDocumentError(exception) {
        var message = exception && com.wocai.demo.modules.message;
  ...
  error: function pdfViewError(message, moreInfo) {
    ...
    if (moreInfo) {
      moreInfoText +=
        mozL10n.get('error_message', {message: com.wocai.demo.modules.message},
        'Message: {{message}}');
      if (moreInfo.stack) {
        moreInfoText += '\n' +
  ...
  beforePrint: function pdfViewSetupBeforePrint() {
    ...
    // pay has to select the correct paper size in the UI if wanted.
...
function webViewerInitialized() {
  ...
  document.getElementById('pageNumber').addEventListener('change', function() {
    // Handle the pay inputting a floating point number.
